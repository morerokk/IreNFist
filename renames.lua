...
if InFmenu.settings.txt_wpnname > 1 then
	LocalizationManager:add_localized_strings({
		bm_w_amcar = "Colt model 733",
		bm_w_m4 = "M4A1",
		bm_w_tecci = "'H&K 416C'",
		bm_w_m16 = "M-16",
		bm_w_olympic = "Olympic Arms K-23",
		bm_w_x_olympic = "Akimbo OAs K-23",
		bm_w_olympicprimary = "Olympic Arms K-23",
		bm_w_contraband = "HK417 with M203 GL'",

		bm_w_ak74 = "AK-74",
		bm_w_akm = "AKM",
		bm_w_akm_gold = "Golden AKM",
		bm_w_akmsu = "AKS-74U'",
		bm_w_akmsuprimary = "AKS-74U'",
		bm_w_x_akmsu = "Akimbo AKS-74Us",
		bm_w_ak12 = "AK-12",

		bm_w_ak5 = "Bofors Ak 5",
		bm_w_asval = "AS VAL",
		bm_w_aug = "Steyr AUG A2",
		bm_w_sub2000 = "Keltec SUB2000", -- concealed assault vector
		bm_w_famas = "FAMAS F1",
		bm_w_s552 = "SIG SG 552",
		bm_w_corgi = " FN F2000 Tactical",
		bm_w_komodo = "IWI X-95",
		bm_w_g36 = "H&K G36 KV",
		bm_w_vhs = "HS Produkt VHS-D2",
		bm_w_l85a2 = "Enfield L85A2",
		bm_w_scar = "FN SCAR-H",
		bm_w_fal = "FN FAL",
		bm_w_g3 = "H&K G3",
		bm_w_galil = "IMI Galil ARM 7.62", -- heavy automatic rifle
		bm_w_m14 = "M14",
		bm_w_ching = "M1 Garand",
		bm_w_tti = "Taran Tactical Innovations TR-1 Ultra-light",
		bm_w_siltstone = "SVD Dragunov",
		bm_w_winchester1874 = "Winchester Model 1873",
		bm_w_msr = "Remington MSR",
		bm_w_wa2000 = "Walther WA2000", -- lakner arms
		bm_w_model70 = "Winchester Model 70",
		bm_w_r93 = "Blaser R93 Tactical 2",
		bm_w_mosin = "Mosin-Nagant",
		bm_w_desertfox = "DTA Stealth Recon Scout", -- vulpes zerda
		bm_w_m95 = "Barrett M95",

		bm_w_coal = "PP-19 Bizon-2",
		bm_w_coalprimary = "PP-19 Bizon-2",
		bm_w_x_coal = "Akimbo PP-19s",
		bm_w_tec9 = "Tec-9",
		bm_w_x_tec9 = "Akimbo Tec-9s",
		bm_w_m1928 = "Thompson M1928",
		bm_w_m1928primary = "Thompson M1928",
		bm_w_x_m1928 = "Akimbo Thompson M1928s",
		bm_w_scorpion = "Sa vz. 61 Skorpion",
		bm_w_x_scorpion = "Akimbo Skorpions",
		bm_w_mp9 = "B&T MP-9",
		bm_w_x_mp9 = "Akimbo MP-9s",
		bm_w_mp5 = "H&K MP-5",
		bm_w_new_mp5primary = "H&K MP-5",
		bm_w_x_mp5 = "Akimbo MP-5s",
		bm_w_schakal = "H&K UMP-45",
		bm_w_schakalprimary = "H&K UMP-45",
		bm_w_x_schakal = "Akimbo UMP-45s",
		bm_w_hajk = "CZ 805 Bren A1",
		bm_w_hajkprimary = "CZ 805 Bren A1",
		bm_w_x_hajk = "Akimbo 805 Brens",
		bm_w_mac10 = "MAC-10",
		bm_w_x_mac10 = "Akimbo MAC-10s",
		bm_w_cobray = "Cobray M11/9",
		bm_w_x_cobray = "Akimbo Cobrays",
		bm_w_erma = "ERMA MP40",
		bm_w_x_erma = "Akimbo MP40s",
		bm_w_mp7 = "H&K MP7 A1",
		bm_w_x_mp7 = "Akimbo MP7s",
		bm_w_sterling = "Sterling L2A3",
		bm_w_x_sterling = "Akimbo Sterlings",
		bm_w_p90 = "FN P90 TR",
		bm_w_x_p90 = "Akimbo P-90s",
		bm_w_shepheard = "SIG-Sauer MPX",
		bm_w_shepheardprimary = "SIG-Sauer MPX",
		bm_w_x_shepheard = "Akimbo MPXs",
		bm_w_m45 = "Carl Gustav M/45B",
		bm_w_x_m45 = "Akimbo M/45Bs",
		bm_w_uzi = "IMI Uzi",
		bm_w_x_uzi = "Akimbo Uzis",
		bm_w_baka = "IMI Micro Uzi",
		bm_w_x_baka = "Akimbo Micro Uzis",
		bm_w_polymer = "KRISS Vector",
		bm_w_x_polymer = "Akimbo Vectors",
		bm_w_sr2 = "SR-2M Veresk",
		bm_w_x_sr2 = "Akimbo Veresks",

		bm_w_b682 = "Beretta 682 ",
		bm_w_huntsman = "Stoeger Uplander",
		bm_w_aa12 = "Atchisson AA-12",
		bm_w_boot = "Winchester Model 1887",
		bm_w_r870 = "Remington 870",
		bm_w_serbu = "Remington 870 SB",
		bm_w_ksg = "Kel-tec KSG", -- kel-tec shot gun
		bm_w_spas12 = "Franchi SPAS-12",
		bm_w_saiga = "Saiga 12K",
		bm_w_benelli = "Benelli M4 Super 90",
		bm_w_judge = "Taurus Judge",
		bm_w_x_judge = "Akimbo Judges",
		bm_w_striker = "Street Sweeper",
		bm_w_m37 = "Ithaca 37",
		bm_w_m37primary = "Ithaca 37",
		bm_w_rota = "Crye Precision SIX12",
		bm_w_x_rota = "Akimbo SIX12s",
		bm_w_basset = "Saiga-12 Bullpup",
		bm_w_x_basset = "Akimbo Saiga-12 Bullpups",
		bm_w_coach = "Remington Exposed-Hammer SxS",
		bm_w_coachprimary = "Remington Exposed-Hammer SxS",
		...
		bm_w_sparrow = "Jericho 941 ",
		bm_w_x_sparrow = "Akimbo Jerichos 941",
		bm_w_pl14 = "Lebedev PL-14",
		bm_w_x_pl14 = "Akimbo PL-14s",
		bm_w_packrat = "H&K P30",
		bm_w_x_packrat = "Akimbo H&Ks P30",
		bm_w_b92fs = "Beretta 92FS",
		bm_w_x_b92fs = "Akimbo Berettas 92FS",
		bm_w_lemming = "FN FiveseveN",
		bm_w_legacy = "H&K M13",
		bm_w_x_legacy = "Akimbo M13s",
		bm_w_glock_17 = "Glock 17",
		bm_w_x_g17 = "Akimbo Glock 17",
		bm_w_glock_18c = "Glock 18c",
		bm_w_x_g18c = "Akimbo Glocks 18c",


		bm_w_g22c = "Glock 22C",
		bm_w_x_g22c = "Akimbo Glocks 22c",
		bm_wp_pis_g26 = "Glock 26 Compact",
		bm_w_jowi = "Akimbo Glock 26s",
		bm_w_usp = "USP .45",
		bm_w_x_usp = "Akimbo USPs",
		bm_w_ppk = "Walther PPK",
		bm_w_x_ppk = "Akimbo PPKs",
		bm_w_colt_1911 = "Springfield Armory 1911 Lightweight Operator",
		bm_w_x_1911 = "Akimbo 1911s",
		bm_w_shrew = "Colt Defender",
		bm_w_x_shrew = "Akimbo Defenders",
		bm_w_p226 = "SIG-Sauger P226R",
		bm_w_x_p226 = "Akimbo P226s",
		bm_w_hs2000 = "LEO-45",
		bm_w_x_hs2000 = "Akimbo LEOs",
		bm_w_c96 = "Mauser C96",
		bm_w_x_c96 = "Akimbo C96s",
		bm_w_breech = "Luger P08",
		bm_w_x_breech = "Akimbo P08s",

		bm_w_peacemaker = "Colt Single Action Army",
		bm_w_raging_bull = "Taurus Raging Bull .44",
		bm_w_x_rage = "Akimbo Raging Bulls",
		bm_w_deagle = "IMI Desert Eagle Mk. XIX",
		bm_w_x_deagle = "Akimbo XIXs",
		bm_w_mateba = "Mateba 2006M",
		bm_w_x_2006m = "Akimbo Matebas",
		bm_w_chinchilla = "M29 Castigo",
		bm_w_x_chinchilla = "Akimbo Castigos",

		bm_w_gre_m79 = "M79",
		bm_w_gre_m79secondary = "M79",
		bm_w_slap = "H&K M320",
		bm_w_m32 = " Milkor MGL Mk 1L",
		bm_w_china = "China Lake Launcher",
		bm_w_arbiter = "ATK XM25 Arbiter",
		bm_w_rpg7 = "RPG-7",
		...
		bm_w_temple = "H&K G11", -- space magic
		bm_w_b93r = "Beretta 93 Raffica",
		bm_w_x_toz66 = "Akimbo TOZ-66s",
		bm_w_pdr = "PDR",
		bm_w_aug9mm = "Steyr AUG A3 XS",
		bm_w_yayo = "Colt M16A2 M203'",
		bm_w_sonny = "Bren Ten",
		...
		bm_w_af2011 = "Arsenal Firearms AF2011",
		bm_w_x_af2011 = "Akimbo AF2011s",
		bm_w_hx25 = "HX25",
		bm_w_amt = "AutoMag",
		bm_w_ots_14_4a = "OTs-14 Groza-4",
		...
		bm_w_p99 = "Walther P99AS",
		bm_w_vepr12 = "VEPR.12",
		bm_w_m3 = "M3A1 Grease Gun",
		...
		bm_w_nya = "Parker-Hale PDW",
		bm_w_x_nya = "Akimbo PDWs",
		bm_w_lazy = "ARX160 A2",
		bm_w_m60 = "M60",
		bm_w_lsat = "LSAT LMG",
		bm_w_fang45 = "Fang 45",
		...
		bm_w_lynx = "GM-6 Lynx",
		bm_w_leet = "Kel-tec RFB", -- kel-tec battle/bullpup rifle, in the same vein as the raven
		bm_w_max9 = "Maxim 9",
		bm_w_auto5 = "Browning Auto-5",
		bm_w_scarl = "FN SCAR-L",
		bm_w_scar_m203 = "FN SCAR-L + M203",
		bm_w_ak12_200 = "AK-2013",
		bm_w_ak12_76 = "AK-2013/76",
		bm_w_beer = "Beretta 93R",
		bm_w_x_beer = "Akimbo Beretta 93R",
		bm_w_calico = "Calico M960",
		bm_w_rusglock = "AF STRIKE One Spetsnaz",
		bm_w_pkpsd9 = "Strike One Spetsnaz LRC-2",
		bm_w_wz35 = "Anti-tank rifle wz.35 'UR' " ,
		bm_w_bigbust = "DSR-1",
		bm_w_carpet = "KSVK 12.7",
		bm_w_enfield_no4i = "Lee-Enfield No.4 Mk.1*",
		bm_w_enfield_no5i = "Lee-Enfield No.5 'Jungle Carbine'",
		bm_w_vick = "Vickers Machine Gun",
		bm_w_spectre_m4 = "SITES Spectre M4",
		bm_w_toz106 = "TOZ-106",
		bm_w_hpb = "Browning High-Power",
		bm_w_fckmyfingers = "Enfield L22A2",
		bm_w_enfieldl22= "Enfield L22A2",
	...
	caliber_r792107 = "7,92 × 107 mm DS",
	...
	caliber_p500 = ".500 Smith & Wesson Magnum",
	...
	caliber_s12g1887 = "10 gauge 2 5/8\".",
...
if InFmenu.settings.txt_wpnname > 1 then
	...
	--PM-63 RAK
	bm_w_pm63_desc = "Polish Cold War Machine pistol, very effective after you overcome the fear of the slide furiously jabbing at your forhead",
	
	--Ares Shrike
	bm_w_beef_desc = "A unicorn among machine guns, it has a lot of the advantages of an AR-15 while minimizing the drawbacks of being an MG. Concealable firepower.",
	
	--AEK 919K
	bm_w_aek919_desc = "AEK 919 Kashtan, which means chestnut, is a very cute little russian machine pistol. Don't try baking it.",
	bm_w_x_aek919_desc = "AEK 919 Kashtan, which means chestnut, is a very cute little russian machine pistol. These here come in pair, double the kashtans.",
	
--SR1M
	bm_w_sr1_desc = "A pair to SR-2 Veresk like FiveseveN to P90, SR1 Gyurza Modernizovana can also defeat armour and punch through ballistic shields while dealing more damage to the targets behind them than the aforementioned 5-7. Less accurate and more recoil.",
	bm_w_x_sr1_desc = "All the pros of a single Gyurza, enough firepower to even bring down Putin if you can get through the guys carrying these.", 
	--M60E4
	bm_w_m60e4_desc = "A shortened variant of the formidable M60 that lets you make your dreams come true, carrying a GPMG as EDC.",
	
	--AS VAL Mod. 3
	bm_w_nightgoddess_desc = "AS Val modified to be more suitable for CQB assaults than clandestine operations, though it will get the job done in both cases, as long as the target isn't too far away",
	
	--CZ Skorpion Evo
		bm_w_czevo_desc = "Sleek, compact and fresh bullet hose, it will easily outrace a Mitsubishi EVO if you can reload fast enough.",
		
	--Calico M960
	bm_w_calico_desc = "One of the first SMGs in the world to provide some serious 9x19 capacity, specifically 100 rounds. This example has been expertly modified by Gage so it doesn't jam if you're off by a crank on the magazine, provided with fully automatic fire mode and fixed sights so you're not on the mercy of the magazines manufacturer to hit your target",
	--KAC PDW
	bm_w_pdw_desc = "The wet dream of every AR-15 OPERATOR, it's a compact assault rifle that'll go through everything thrown at you at anytime, thanks to it's proprietary 6x35 ammunition and compact dimensions.",
	
	--CZ-75 Czechmate
	bm_w_axewscope_desc = "The pun in it's name is quite accurate, it's a race gun chambered in .40 S&W. No recoil, very accurate (especially when standing still) with a mechanism that can work way faster than you can. Not too many customization options though.",
	
	bm_w_wz35_desc = " Polish WW2 anti-tank rifle, using a small diameter bullet to deepen penetration when compared to other contemporary AT rifles, nicknamed UR because it was hidden in crates marked for export to Urugway. Like many weapons, it was captured by Germans and pressed into service, even though it really didn't want to",
	bm_w_bigbust_desc = "DSR-1 is a compact, yet extremely accurate sniper rifle, widely adopted all across European police units. It's fed from two magazines at the same time to increase accuracy :) (Not really, the one in front serves as mag holder)",
	bm_w_carpet_desc = "Russians wanted to get in on the big bore action and show Americans how it's done. This was their ticket, a suppressable anti-materiel rifle, allowing them to destroy trucks without losing their hearing",
	bm_w_enfield_no4i_desc = "WW2 era British rifle, from a line of firearms that dates to XIX century. Its predecessors spawned one of the most legendary training drills, the Mad Minute, allowing them to flex on their enemies. Known for it's smooth action and fed from a 10 round magazine, unlike most of its competitors, it was one of the best rifles of WW2. The star signifies a simplified version.",
	bm_w_enfield_no5i_desc = "Designed for British paratroopers, but never used by them. However, as it turns out, in the jungle having a more maneuverable weapon is more important than 1 mile accuracy which was pretty handy in later conflicts",
	bm_w_vick_desc = "Legendary water-cooled machine gun, mainly used by the British in both world wars and long after. It's reliability allowed for some unorthodox tactics, like volley fire on an enemy while cooling your machine gun with urine because you've used up all the water you had available or boiling tea in the waterjacket. You could say it was the first truly universal machine gun",
	bm_w_spectre_m4_desc = " Italian SMG, one of the first weapons to use a quadstack magazine. Even though it's not well known, you can trust it to rain lead on your enemies for an extended period of time. Still used today by Italian police",
	bm_w_toz106_desc = "Another TOZ shotgun. As you can see, Russians really like them. This one differs in operation, being a bolt-action and helping it stand out a little bit out of the crowd",
	bm_w_hpb_desc = "Belgian WW2 era handgun, drafted by John Browning and finished by FN, it was the first commercialy available pistol with a double stack magazine, which held 13 rounds while still looking normal",
	bm_w_fckmyfingers_desc = " PDW that's a part of L85 family of weapons, made after the British gave up and paid H&K to fix it for them, ushering forward a new era for British infantrymen, an era where you could empty a magazine of your rifle and not deal with any stoppages",
	bm_w_enfieldl22_desc = " PDW that's a part of L85 family of weapons, made after the British gave up and paid H&K to fix it for them, ushering forward a new era for British infantrymen, an era where you could empty a magazine of your rifle and not deal with any stoppages",
	--Fightlite Raider
	bm_w_raider_desc = "Basically it's a semi auto rifle you can hide in your pocket, if you can handle the shame of using something so ugly.",
	--Prokolot Strike One
	bm_w_rusglock_desc = "Lowest recoil ever, ultra low bore axis, extreme precision, Russian governments next official handgun and so on. Too bad Russians exiled its creator and it never went anywhere. This one's a variant intended for special forces. Notably also, this gun is continued by Salient Arms as Stryk, food for thought.",
	--Strike One LRC-2
	bm_w_pkpsd9_desc = "Same ultra low bore axis, lowest recoil ever, extreme precision, only in a dedicated stock",
	--R4 CQB
	bm_w_m4cqb_desc = "Short barreled version of the full size R4 (Duh). This is the mega tacticool version, as it's chambered in Remington 6.8 SPC.",
	--OTs-33
	bm_w_ots_33_desc = "Russians always liked fully automatic pistols, as evidenced by being the first army in the world to adopt one for use in the army, Pernach is a successor to the original APS intended for Spetsnaz, only way better. Higher ROF, lower weight, beautiful Minecraft stylization and a built-in compensator",
	--.500 S&W Magnum
	bm_w_shatters_fury_desc = "Did he fire six shots or only five'? Well to tell you the truth, in all this excitement, I kind of lost track myself. But being that the original that this quote alludes to was a .44 Magnum and this is a .500 S&W Magnum, the now most powerful handgun in the world, and would blow your head clean off and shatter the guy behind you, you've got to ask yourself and that guy one question: 'Do ye feel lucky?",
