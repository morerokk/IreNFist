...
if InFmenu.settings.enablenewcopbehavior then
	...
	function HuskPlayerDamage:damage_melee(attack_data)
		...
		local result = IREnFIST.CopUtils:CheckClientMeleeDamageArrest(self._unit, attack_data.attacker_unit, true)
		...
		elseif result == "countered" then
			return IREnFIST.CopUtils:KnockDownAttacker(self._unit, attack_data.attacker_unit)
