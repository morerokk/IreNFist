...
if InFmenu.settings.sanehp == true then
	Hooks:PostHook(CharacterTweakData, "_init_fbi_heavy_swat", "inf_chartweak_init_tan_bodyarmor", function(self)
		...
		self.fbi_heavy_swat.headgear_flyoff_chance = 0.35
	end)
end
...
if InFmenu.settings.enablenewcopbehavior then
	Hooks:PostHook(CharacterTweakData, "init", "inf_chartweak_init_cop_arrest_tactics", function(self)
		...
		self.swat.arrest_player_priority = 2 -- Blues (formerly this tweakdata also included one type of HRT but this mod un-fucks that)
